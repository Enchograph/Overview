...
- P3 阶段的邮箱认证、受保护同步、离线恢复与最小冲突标记已全部闭环，P4 当前已完成文本解析、待确认结构化结果和单轮问答三条主链路
