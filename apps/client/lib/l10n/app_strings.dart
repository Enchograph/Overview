const localizedValues = <String, Map<String, String>>{
  'en': {
    ...
    'captureAiConfirmAction': 'Confirm and create',
    'captureAiStartAtLabel': 'Start time',
    'captureAiEndAtLabel': 'End time',
    'captureAiDueAtLabel': 'Due time',
    'captureAiLocationLabel': 'Location',
    'captureAiDurationLabel': 'Duration (minutes)',
    'captureAiListIdLabel': 'List',
    'captureAiDateTimeHint': 'Use ISO time, for example 2026-03-13T20:00:00Z',
    'captureAiDurationHint': 'For example 30',
    'captureAiDismissAction': 'Dismiss',
    'captureVoiceAction': 'Record voice',
    'captureVoiceStopAction': 'Stop recording',
    'captureVoiceTranscribing': 'Transcribing...',
    'captureVoiceUnavailableTitle': 'Voice unavailable',
    ...
    'shortcutsTitle': 'App shortcuts',
    'shortcutsBody':
        'Long press the app icon to jump straight to Week or Capture.',
    'shortcutsWeekLabel': 'Open week',
    'shortcutsCaptureLabel': 'Open capture',
    'authTitle': 'Account',
    ...
    'aiBody':
        'Ask one planning question at a time and get a quick answer grounded in your current items.',
    'aiCta':
        'Use this page for quick planning questions without leaving the app shell.',
    'aiQuestionLabel': 'Question',
    'aiQuestionHint': 'What should I focus on tomorrow?',
    'aiAskAction': 'Ask AI',
    'aiSubmitting': 'Thinking...',
    'aiClearAction': 'Clear',
    'aiAnswerTitle': 'AI answer',
    'aiReferencedItems': 'Referenced {count} planning items.',
  ...
  'zh': {
    ...
    'captureAiConfirmAction': '确认后创建',
    'captureAiStartAtLabel': '开始时间',
    'captureAiEndAtLabel': '结束时间',
    'captureAiDueAtLabel': '截止时间',
    'captureAiLocationLabel': '地点',
    'captureAiDurationLabel': '时长（分钟）',
    'captureAiListIdLabel': '列表',
    'captureAiDateTimeHint': '使用 ISO 时间，例如 2026-03-13T20:00:00Z',
    'captureAiDurationHint': '例如 30',
    'captureAiDismissAction': '关闭',
    'captureVoiceAction': '语音录入',
    'captureVoiceStopAction': '停止录音',
    'captureVoiceTranscribing': '转写中...',
    ...
    'shortcutsTitle': '快捷入口',
    'shortcutsBody': '长按应用图标后，可直接进入周视图或添加页。',
    'shortcutsWeekLabel': '打开周视图',
    'shortcutsCaptureLabel': '打开添加页',
    'authTitle': '账号',
    ...
    'authSuccess': '账号会话已就绪。',
    'aiTitle': 'AI 助手',
    'aiBody': '在这里一次提一个规划问题，快速拿到基于当前条目的 AI 回答。',
    'aiCta': '这个页面用于在应用内直接发起快速规划问答。',
    'aiQuestionLabel': '问题',
    'aiQuestionHint': '例如：我明天应该先做什么？',
    'aiAskAction': '询问 AI',
    'aiSubmitting': '思考中...',
    'aiClearAction': '清空',
    'aiAnswerTitle': 'AI 回答',
